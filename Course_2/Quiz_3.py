...
The key is the course name and the value is the number of credits. Find the total number of credits taken this semester and 
...
best_char=keys[0]
for k in keys:
    if characters[best_char] < characters[k]:
        best_char =k
print(k)
########################
######Question_7########
...
worst_char=keys[0]
for k in keys:
    if characters[worst_char] > characters[k]:
        worst_char =k
print(k)
########################
######Question_8########
"""Create a dictionary named letter_counts that contains each letter and the number of times it occurs in string1. Challenge: Letters should not be counted separately as 
upper-case and lower-case. Intead, all of them should be counted as lower-case."""
...
character was seen. Make sure that there are no repeats of characters as keys, such that “T” and “t” are both seen as a “t”
for example."""
