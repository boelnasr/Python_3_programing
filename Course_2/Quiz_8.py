########################
######Question_1########
"""ort the following string alphabetically, from z to a, and assign it to the variable sorted_letters """
...
########################
######Question_3########
"""he dictionary, medals, shows the medal count for six countries during the Rio Olympics. 
...
the number 17573005 should return 3005. Then, use this function to sort the list of ids stored in the variable, ids,
from lowest to highest. Save this sorted list in the variable, sorted_ids. Hint: Remember that only strings can be indexed,
...
Do this using lambda and not using a defined function. Save this sorted list in the variable sorted_id."""
ids = [17573005, 17572342, 17579000, 17570002, 17572345, 17579329]
