...
import random
import time
sys.setExecutionLimit(600000) # let this take up to 10 minute
LETTERS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
VOWELS  = 'AEIOU'
VOWEL_COST  = 250
class WOFPlayer:##define player class
    ...
    def __str__(self):
        ...
        return self.name + "has $" + self.prizeMoney
    
class WOFHumanPlayer(WOFPlayer):##human player
    def getMove(self,category, obscuredPhrase, guessed):
        return input("{}  has $+ {}+ /n  , Category:  {} /n" \
        ", Phrases: /n  {} /n  , Guessed:  {} + /n"  \
        "Guess a letter, phrase, or type 'exit' or 'pass':".format(self.name,str(self.prizeMoney),category,obscuredPhrase,guessed)) 
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getPossibleLetters(self,gussed):
        list=[]
